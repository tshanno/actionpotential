...
<body>
	<div id="wrapper">
		<div id="header">
			...
			<input type="hidden" id="D" name="choice" value="D"><span class='label' id='label_D' value='enabled' hidden=true>D</span>
			<input type="hidden" id="E" name="choice" value="E"><span class='label' id='label_E' value='enabled' hidden=true>E</span>
